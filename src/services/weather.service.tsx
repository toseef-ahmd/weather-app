...
import { mapCurrentWeather, mapHourlyWeather, mapWeeklyWeather } from "../utils/data_parser.util";

export async function fetchWeatherData(): Promise<IForecast | Error> {
    try {
        ...
        const currentParams: string = "temperature_2m,relative_humidity_2m,is_day,precipitation,weather_code,wind_speed_10m,wind_direction_10m";
